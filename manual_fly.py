...
def main():
    ...
    ap.add_argument("--rate-roll", type=float, default=140.0, help="max roll deg/s at full stick (racing: 540)")
    ap.add_argument("--rate-pitch", type=float, default=140.0, help="max pitch deg/s at full stick (racing: 540)")
    ap.add_argument("--rate-yaw", type=float, default=100.0, help="max yaw deg/s at full stick (racing: 360)")
